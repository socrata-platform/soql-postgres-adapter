...
class SoQLConversionFunctionsTest extends SoQLTest {
  ...
  // TODO: Implement text to location
  ignore("text::location") {
    compareSoqlResult("""select code, location where location='{ "latitude": 1.1, "longitude": 2.2, "human_address": "{\"address\":\"101 Main St\", \"city\": \"Seattle\", \"state\": \"WA\", \"zip\": \"98104\"}"}'""",
